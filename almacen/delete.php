<?php
global $pdo, $productos_datos, $categorias_datos, $URL, $id_usuario, $nombre, $codigo, $nombre_categoria, $descripcion, $stock_minimo, $stock_maximo, $precio_compra, $precio_venta, $fecha_ingreso, $stock,$id_producto_get;
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Información del Producto: <?php echo $nombre;?> a eliminar </h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <div class="col-md-12">
                    <div class="card card-danger">
                        <div class="card-header">
                            <h3 class="card-title">¿Desea eliminar el producto?</h3>

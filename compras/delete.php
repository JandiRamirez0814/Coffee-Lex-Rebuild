<?php
global $pdo, $productos_datos, $categorias_datos, $URL, $id_usuario, $proveedores_datos, $compras_datos, $nro_compra, $codigo, $nombre_categoria, $descripcion, $stock, $stock_minimo, $stock_maximo, $fecha_ingreso, $nombre_proveedor, $empresa, $id_compra_get, $fecha_compra, $comprobante, $precio_compra, $cantidad, $id_producto;
                            ...
                            <div class="card card-outline card-danger">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <button id="btn_eliminar" class="btn btn-danger btn-block">

<?php
global $pdo, $email, $id_usuario_get, $rol, $roles_datos;
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form action="../app/controllers/usuarios/update.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nombres" class="form-control" value="<?php /** @var TYPE_NAME $nombress */
                                            echo $nombress;?>" placeholder="Digite el nombre del usuario a registrar" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Email</label>
                                            <input type="email" name="email" class="form-control" value="<?php echo $email;?>" placeholder="Digite el email del usuario a registrar" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Rol</label>
